...
struct MotorCurrent_
{
  ...
  _name_type name;
   ...
   typedef std::vector<float, typename ContainerAllocator::template rebind<float>::other >  _continuous_current_limit_type;
  _continuous_current_limit_type continuous_current_limit;

   typedef std::vector<float, typename ContainerAllocator::template rebind<float>::other >  _current_peak_time_type;
  _current_peak_time_type current_peak_time;

   typedef std::vector<float, typename ContainerAllocator::template rebind<float>::other >  _current_peak_limit_type;
