...
struct WatchdogStatusArray_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::robotnik_msgs::WatchdogStatus_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::robotnik_msgs::WatchdogStatus_<ContainerAllocator> >::other >  _status_type;
  _status_type status;
